...
class Game {
    ...
    constructor () {
        ...
        this.score = 0; //puntaje del juego
   
    }
    showscore ()
    {
        let  ptos=document.querySelector("#scoreli");
        return ptos.dataset.score=this.score;
    }
    showslives ()
    {
        let  ptos=document.querySelector("#livesli");
        return ptos.dataset.lives=this.player.lives;
    }
    /**
